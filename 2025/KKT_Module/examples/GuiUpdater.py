import time
import os
from KKT_Module.KKT_Module.GuiUpdater import Updater
import numpy as np
from PySide2 import QtWidgets
from collections import deque
from KKT_Module.KKT_Module.ksoc_global import kgl
from KKT_Module.KKT_Module.Configs import RecordingConfigs
from KKT_Module.KKT_Module.SettingProcess.SettingProccess import SettingConfigs
from KKT_Module.KKT_Module.KKTUtility import GestureObserver
# from KKT_Module.KKT_Module.QtObject.ModeWindow import ModeWindow, KKTMainWindow
from KKT_Module.KKT_Module.KKTUtility import PostProcess
from KKT_Module.KKT_Module.KKTUtility import Debounce
...
class RawDataUpdater(Updater):
    ...
    def addWidgetToCanvas(self):
        from KKT_Module.KKT_Module.KKTGraph.ShowRawData import RawDataGraph
...
class HardwareInferenceUpdater(Updater):
    ...
    def addWidgetToCanvas(self):
        from KKT_Module.KKT_Module.KKTGraph.ShowResults import DrawingResult_GS
    ...
    def addWidgetToSublayout(self):
        from KKT_Module.KKT_Module.kkt_module.KKTUtility import CollapsibleSection
...
class TrackingUpdater(Updater):
    ...
    def setup(self, win:ModeWindow):
        self.win = win
        from KKT_Module.KKT_Module.KKTGraph.ShowTracking import DrawingPosition
...
class FeatureMapUpdater(Updater):
    ...
    def setup(self, win):
        from KKT_Module.KKT_Module.KKTGraph.ShowFeatureMap import FeatureMapWidget
        self.win = win
...
class KKTDataSafer:
    ...
    def _crypt_file_save(self, BytesIOObject, KKT_file_path):
        ...
        from io import BytesIO
        from KKT_Module.KKT_Module.kkt_module.KKTUtility import Get_Crypted_Key, Encode_BytesIOObject
